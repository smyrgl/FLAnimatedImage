Pod::Spec.new do |spec|
  ...
  spec.homepage         = 'https://github.com/smyrgl/FLAnimatedImage'
  spec.screenshots      = 'https://github.com/smyrgl/FLAnimatedImage/raw/master/images/flanimatedimage-demo-player.gif'
